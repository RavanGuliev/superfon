    ...
    <div className='max-w-[1400px] mx-auto min-h-[100vh] flex flex-col md:flex-row gap-8 pt-9 px-3 items-center md:items-start rubik'>
      <div>
        <div className="w-full md:w-[398px] border border-[#e5e8ec] rounded-md flex-shrink-0">
          <img src={`https://cdn.superfon.az/i/p/300/${product ? product.image ?? "Ad yoxdur" : "Yüklənir..."}`} alt="" className='w-[398px]' />
        </div>
      ...
      <div className="w-full md:flex-1 min-w-0">
        ...
        <div>
          <h1 className='text-[22.4px] text-[#021523] font-bold pb-2.5'> {product ? product.title ?? "Ad yoxdur" : "Yüklənir..."}</h1>
          <div className="flex items-center gap-3">
            <p className="text-[14.4px] text-[#818ea0] pb-1">
              Məhsulun kodu: {product ? product.id ?? "Qiymət yoxdur" : "Yüklənir..."}
            </p>
        ...
        <div>
          <p className='text-[24px] font-semboli'>{product ? product.price ?? "Qiymət yoxdur" : "Yüklənir..."} ₼</p>
        </div>
        ...
        <div className='border border-[#e5e8ec] p-3 rounded-md max-w-full overflow-hidden'>
          <div className='flex flex-wrap gap-3 p-2 items-center'>
            ...
            <div className='flex flex-wrap gap-3 flex-1 min-w-[200px]'>
              <button onClick={handleAddToCart} className='text-white text-[14.4px] max-w-[135px] w-full font-semibold bg-[#24bb42] flex items-center hover:bg-[#1f7931] p-2 rounded-md flex-shrink-0 min-w-[120px] justify-center'>Sebete elave et</button>
              <button className='text-white text-[14.4px] font-semibold bg-[#3c1e6e] max-w-[80px] w-full flex items-center p-2 rounded-md flex-shrink-0 min-w-[100px] justify-center'>Indi al</button>
              {product && (
